...
const Adventure = (props) => {
  ...
  const { tagData, getTagData, settingData, getSettingData, destinationData, getDestinationData, header, tagtitle} = props;
  const [loader, setLoader] = useState(true);
  const refferencr = useRef(null);
    console.log('Adventure=', tagData);
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(Adventure));
